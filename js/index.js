...
const spaceCountElement = document.querySelector(".space__count");
...
textInput.addEventListener("input", () => {
  ...
  const letterCount = (textInput.value.match(/[a-z]/gi) || null).length;
...
const colors = ["red", "blue", "yellow", "purple", "green", "black", "orange"];
let i = 0;
